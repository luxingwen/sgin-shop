...
type SysAPI struct {
	...
	CreatedAt       time.Time `gorm:"autoCreateTime;type:datetime" json:"-"` // CreatedAt 记录了API创建的时间
	UpdatedAt       time.Time `gorm:"autoUpdateTime;type:datetime" json:"-"` // UpdatedAt 记录了API信息最后更新的时间
