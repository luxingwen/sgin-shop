...
type Page struct {
	...
	CreatedAt string `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 页面创建时间
	UpdatedAt string `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 页面最后更新时间
}
