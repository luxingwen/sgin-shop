...
type App struct {
	...
	CreatedAt time.Time `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 记录了调用方创建的时间
	UpdatedAt time.Time `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 记录了调用方信息最后更新的时间
