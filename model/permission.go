...
type Permission struct {
	...
	CreatedAt  string `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 记录了权限创建的时间
	UpdatedAt  string `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 记录了权限信息最后更新的时间
}
...
type PermissionMenu struct {
	...
	CreatedAt      string `gorm:"autoCreateTime;type:datetime" json:"-"`      // CreatedAt 记录了权限菜单创建的时间
	UpdatedAt      string `gorm:"autoUpdateTime;type:datetime" json:"-"`      // UpdatedAt 记录了权限菜单信息最后更新的时间
}
...
type UserPermission struct {
	...
	PermissionUuid string `gorm:"type:char(36);index" json:"permission_uuid"`     // PermissionUuid 是权限的 UUID
	CreatedAt      string `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 记录了用户权限关联创建的时间
	UpdatedAt      string `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 记录了用户权限关联信息最后更新的时间
}
