...
type Menu struct {
	...
	CreatedAt  time.Time `gorm:"autoCreateTime;type:datetime" json:"-"`      // CreatedAt 记录了菜单创建的时间
	UpdatedAt  time.Time `gorm:"autoUpdateTime;type:datetime" json:"-"`      // UpdatedAt 记录了菜单信息最后更新的时间
}
...
type MenuAPI struct {
	...
	CreatedAt time.Time `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 记录了关联关系的创建时间
	UpdatedAt time.Time `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 记录了关联关系的最后更新时间
}
