...
type UserRole struct {
	...
	CreatedAt time.Time `gorm:"autoCreateTime;type:datetime" json:"created_at"` // CreatedAt 记录了用户获得角色的时间
	UpdatedAt time.Time `gorm:"autoUpdateTime;type:datetime" json:"updated_at"` // UpdatedAt 记录了用户角色信息最后更新的时间
}
